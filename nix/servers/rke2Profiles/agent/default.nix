...
in
{
  ...
  systemd.services.rke2-agent = {
    ...
    script = ''${nixpkgs.rke2}/bin/rke2 agent --server https://consortium.cephalonetes.lan.gigglesquid.tech:9345 --token-file ${config.sops.secrets.rke2_token.path}  --tls-san "10.10.4.40,consortium.cephalonetes.lan.gigglesquid.tech" --disable "rke2-ingress-nginx" --disable-cloud-controller'';
    serviceConfig = {
      Type = "notify";
      KillMode = "process";
      Delegate = "yes";
