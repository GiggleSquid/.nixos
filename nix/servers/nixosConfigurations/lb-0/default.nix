    ...
    keepalived = {
      ...
      vrrpInstances = {
        "loadbalancer_IPv4_1" = {
          ...
          unicastSrcIp = "10.101.0.30";
          unicastPeers = [ "10.101.0.31" ];
          virtualIps = [
            {
              addr = "10.100.0.10";
              dev = "enp6s18.100";
        ...
        "loadbalancer_IPv6_1" = {
          ...
          priority = 255;
          interface = "enp6s18.101";
          unicastSrcIp = "2a0b:9401:64:101::30";
          unicastPeers = [ "2a0b:9401:64:101::31" ];
          virtualIps = [
            {
      ...
      extraConfig =
        ...
        ''
        + (lib.readFile ./_ipvs-virtual-servers.conf);
    };
